   ...
   /*    stage('DEPLOY to Artifactory') { 
	...
	stage('Download an Artifact') { 
            steps {
                ...
                bat "mvn dependency:get -DrepoUrl=http://localhost:8081/artifactory/libs-snapshot-local  -Dartifact=com.sample:sample-demo:0.0.1-SNAPSHOT:jar -Dtransitive=false -Ddest=C:/artifactDownLocsample-demo.jar"    
